...
export function GatedCTA({ feature, onRun, onUpgrade }:{
  feature: 'calculators_advanced'|'secure_vault'|'custody_router';
  onRun: () => void;
  onUpgrade: () => void;
}) {
  ...
  return (
    <div className="flex items-center gap-2">
      <span className="text-sm text-muted-foreground">Requires {feature==='calculators_advanced'?'Premium':'Elite'} plan</span>
