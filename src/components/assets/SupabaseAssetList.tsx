...
import { EditSupabaseAssetDialog } from "./EditSupabaseAssetDialog";
import { DeleteSupabaseAssetDialog } from "./DeleteSupabaseAssetDialog";

interface SupabaseAssetListProps {
  filter: string;
}
...
export const SupabaseAssetList: React.FC<SupabaseAssetListProps> = ({ filter }) => {
  ...
  return (
    <div className="space-y-4">
      ...
      <EditSupabaseAssetDialog 
        open={isEditDialogOpen} 
        onOpenChange={setIsEditDialogOpen} 
        asset={selectedAsset} 
      />
      
      <DeleteSupabaseAssetDialog 
