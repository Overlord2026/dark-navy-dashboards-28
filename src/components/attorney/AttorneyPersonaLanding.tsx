...
import { Scale, TrendingUp, Shield, Zap } from 'lucide-react';
import { motion } from 'framer-motion';

interface AttorneyPersonaLandingProps {
  onExploreFeatures: () => void;
}

export const AttorneyPersonaLanding: React.FC<AttorneyPersonaLandingProps> = ({
  onExploreFeatures
}) => {
  return (
    <motion.div
      ...
      <Card className="relative overflow-hidden">
        ...
        <CardHeader className="relative text-center pb-8">
          ...
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto leading-relaxed">
            Streamline case management. Manage compliance. Grow your client base.
          </p>
        </CardHeader>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-8">
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Lead-to-Sales Marketing Engine with automated legal service campaigns
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                Automated CLE tracking, compliance calendar, and audit-ready documentation
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-sm text-muted-foreground">
                AI document drafting, case summaries, and estate planning automation
              </p>
            </motion.div>
          </div>
