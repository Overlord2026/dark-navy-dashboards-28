...
const FundDetailPanel: React.FC<FundDetailPanelProps> = ({ offering, onClose }) => {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-full md:w-[500px] bg-[#0a1122] border-l border-gray-800 shadow-xl z-50 overflow-y-auto">
      <div className="p-6 space-y-6">
        ...
        <Tabs defaultValue="details" className="mt-6">
          <TabsList className="w-full mb-6 bg-[#1a283e]">
            <TabsTrigger 
              value="details"
              className="py-2 flex-1 data-[state=active]:bg-primary"
            >
              Details
            </TabsTrigger>
            <TabsTrigger 
