...
import { Crown, Users, Briefcase, Phone, Building2, ArrowRight } from 'lucide-react';
    ...
    <div className="min-h-screen pt-16 bg-gradient-to-br from-navy via-navy to-slate-900">
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center w-16 h-16 mb-6 mx-auto rounded-full bg-gradient-to-br from-gold to-yellow-400 shadow-gold">
            <Crown className="w-10 h-10 text-navy" />
          </div>
