  ...
  return (
    <div className="w-full">
      <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-4 gap-4">
        <Card className={isLightTheme ? "bg-blue-50" : "bg-blue-900/20"}>
        ...
        <Card className={isLightTheme ? "bg-purple-50" : "bg-purple-900/20"}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card className={isLightTheme ? "bg-teal-50" : "bg-teal-900/20"}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
        ...
        <Card className={isLightTheme ? "bg-amber-50" : "bg-amber-900/20"}>
          <CardContent className="p-4">
            <div className="flex items-center justify-between">
              <div>
