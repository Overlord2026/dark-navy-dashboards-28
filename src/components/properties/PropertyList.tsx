...
import { PropertyCardSkeleton } from "@/components/ui/skeletons/PropertiesSkeletons";
...
export const PropertyList: React.FC<PropertyListProps> = ({ 
  ...
  const handleExpand = useCallback((propertyId: string) => {
  ...
  const calculateAppreciation = useCallback((originalCost: number, currentValue: number): number => {
  ...
  }, [properties, expandedPropertyId, formatCurrency, getPropertyIcon, getPropertyTypeLabel, calculateAppreciation, handleExpand, onEdit, confirmDelete]);
