...
export function AddCollaboratorDialog({ 
  ...
  const onSubmit = (values: z.infer<typeof formSchema>) => {
    ...
    // Add collaborator after a short delay
    setTimeout(() => {
      onAddCollaborator({
      ...
      // Reset form and close dialog after showing success for a few seconds
      setTimeout(() => {
        form.reset();
        setStep(1);
        setShowSuccess(false);
        ...
        {!showSuccess ? (
          ...
          <div className="flex flex-col items-center justify-center py-8">
            <div className="w-full text-center mb-6">
              <img 
                src="/lovable-uploads/2436c2af-e13e-436c-970a-a77e01ba2cd5.png" 
                alt="Collaborator added successfully" 
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 mb-4">
                Your collaborator will receive an email with instructions to access your shared information.
              </p>
            </div>
          </div>
        )}
