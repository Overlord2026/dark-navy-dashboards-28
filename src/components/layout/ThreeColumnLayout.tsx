...
export function ThreeColumnLayout({ 
  ...
  return (
    <div className={`flex h-screen w-full overflow-hidden ${isLightTheme ? 'bg-[#F9F7E8]' : 'bg-[#12121C]'}`}>
      ...
      <div className="flex-1 flex flex-col overflow-hidden mt-[120px] w-full">
        {isHomePage ? (
          <div className="flex flex-col items-center justify-center w-full h-full p-8">
            <div className="w-full max-w-4xl flex justify-center mb-8">
              <Link to="/education" className="w-1/2 flex items-center justify-center gap-3 px-8 py-6 rounded-md bg-gray-800 hover:bg-gray-700 text-gray-100 transition-colors border border-primary">
                <GraduationCapIcon className="h-8 w-8" />
                <span className="font-medium text-xl">Education Center</span>
              </Link>
            </div>
            
            <div className="w-full max-w-4xl flex justify-center">
              <Link to="/vault" className="w-1/2 flex items-center justify-center gap-3 px-8 py-6 rounded-md bg-gray-800 hover:bg-gray-700 text-gray-100 transition-colors border border-primary">
                <BookOpenIcon className="h-8 w-8" />
                <span className="font-medium text-xl">Family Legacy Vault</span>
              </Link>
            </div>
          </div>
        ) : null}
