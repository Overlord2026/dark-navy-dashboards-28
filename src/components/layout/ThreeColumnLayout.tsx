...
export function ThreeColumnLayout({ 
  ...
  return (
    <div className={`flex h-screen overflow-hidden ${isLightTheme ? 'bg-[#F9F7E8]' : 'bg-[#12121C]'}`}>
      <aside
        className={cn(
          "h-screen flex flex-col transition-all duration-300 ease-in-out z-30 pt-64", // Increased to pt-64 to align with Net Worth Summary
      ...
      >
        ...
        <Button
          variant="ghost"
          size="icon"
          className={`absolute top-64 right-0 translate-x-1/2 h-8 w-8 rounded-full bg-background border border-border text-foreground hover:bg-accent hover:text-sidebar-primary-foreground z-40 ${isLightTheme ? 'bg-[#F9F7E8] text-[#222222] border-[#DCD8C0]' : ''}`}
      ...
      {hasSecondaryMenu && (
        <aside
          className={cn(
            "h-screen flex flex-col transition-all duration-300 ease-in-out z-20 pt-64", // Increased to pt-64 to align with Net Worth Summary
        ...
        >
          ...
          <Button
            variant="ghost"
            size="icon"
            className={`absolute top-64 h-8 w-8 rounded-full border text-foreground z-40 ${
              isLightTheme 
