            ...
            <div className="space-y-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Manage accounts used for transfers and payments
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <div className="space-y-4">
                    <p className="text-sm text-muted-foreground">
                      Funding accounts are used for transfers, payments, and investments. 
                      You can add a new account or manage your existing ones.
                    </p>
                    
                    <Button 
                      className="w-full md:w-auto mt-4 flex items-center" 
                      onClick={() => setShowManageFundingDialog(true)}
                    >
                  ...
                  <div className="space-y-4">
                    {fundingAccounts.length > 0 ? (
                      <div className="divide-y">
                        {fundingAccounts.map((account) => (
                          <div key={account.id} className="py-3 flex justify-between items-center">
                            ...
                            <Button variant="ghost" size="sm" onClick={() => setShowManageFundingDialog(true)}>Edit</Button>
                          </div>
                        ))}
                      </div>
                    ) : (
                      <div className="text-center py-8">
                        ...
                        <Button className="mt-4" onClick={() => setShowManageFundingDialog(true)}>
