...
import { Heart, FileText, Activity, Users, ArrowRight, ExternalLink, DollarSign } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import { LandingNavigation } from '@/components/marketplace/LandingNavigation';
import { BrandedFooter } from '@/components/ui/BrandedFooter';

export const HealthcarePersonaPage: React.FC = () => {
  const navigate = useNavigate();

  const features = [
    {
      icon: FileText,
      title: 'Patient Record Vault & Wellness Tools',
      description: 'Secure patient data management, wellness tracking, and comprehensive health record systems.'
    },
    {
      icon: Activity,
      title: 'Marketplace for Advanced Diagnostics',
      description: 'Access to cutting-edge diagnostic tools, lab integrations, and advanced health analytics.'
    },
    {
      icon: Users,
      title: 'Longevity Planning Suite',
      description: 'Comprehensive longevity planning tools, health optimization strategies, and patient engagement.'
    }
  ];
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Advanced healthcare management tools, patient engagement platform, and longevity planning 
                designed for modern healthcare providers and Medicare specialists.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                onClick={() => navigate('/demo/healthcare')}
