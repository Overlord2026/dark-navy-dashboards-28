...
import { Briefcase, Users, TrendingUp, BarChart3, ArrowRight, ExternalLink, DollarSign } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import { LandingNavigation } from '@/components/marketplace/LandingNavigation';
import { BrandedFooter } from '@/components/ui/BrandedFooter';

export const AdvisorPersonaPage: React.FC = () => {
  ...
  const features = [
    {
      ...
      description: 'Complete CRM, client portal, and practice analytics to grow your advisory business.'
    },
    {
      icon: TrendingUp,
      title: 'Lead-to-Sale Engine',
      description: 'SWAG Lead Score™, automated follow-ups, and conversion optimization tools.'
    },
    {
      icon: BarChart3,
      title: 'Compliance & Analytics',
      description: 'Built-in compliance monitoring, reporting, and detailed client engagement analytics.'
    }
  ];
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Complete practice management tools, lead generation engine, and client engagement platform 
