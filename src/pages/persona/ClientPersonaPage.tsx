...
import { Users, Shield, TrendingUp, FileText, ArrowRight, ExternalLink, DollarSign } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import { motion } from 'framer-motion';
import { LandingNavigation } from '@/components/marketplace/LandingNavigation';
import { BrandedFooter } from '@/components/ui/BrandedFooter';

export const ClientPersonaPage: React.FC = () => {
  const navigate = useNavigate();

  const features = [
    {
      icon: Shield,
      title: 'Secure Wealth Dashboard',
      description: 'Complete view of your assets, investments, and financial health in one secure portal.'
    },
    {
      icon: TrendingUp,
      title: 'Investment Management',
      description: 'Professional portfolio management with transparent fees and fiduciary oversight.'
    },
    {
      icon: FileText,
      title: 'Estate & Tax Planning',
      description: 'Comprehensive planning tools to optimize your tax strategy and preserve your legacy.'
    }
  ];
          ...
          >
            ...
            <div className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">
                Access the same wealth management tools and services that ultra-wealthy families use, 
                designed for the modern millionaire family.
              </p>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Button 
                size="lg"
                onClick={() => navigate('/signup?plan=client-basic')}
