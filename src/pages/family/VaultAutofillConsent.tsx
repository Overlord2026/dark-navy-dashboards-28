...
export default function VaultAutofillConsent() {
  ...
  return (
    <div className="container mx-auto py-6 max-w-4xl">
      <div className="mb-6">
        <h1 className="text-2xl font-bold mb-2">Vault Auto-Populate Settings</h1>
            ...
            {consent ? (
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <Button variant="outline" onClick={handleRevokeConsent} disabled={loading}>
          ...
          <CardContent className="space-y-6">
            <div className="grid gap-4">
              {Object.entries(SCOPE_DESCRIPTIONS).map(([scope, description]) => (
                <div key={scope} className="flex items-center justify-between space-x-4 p-4 border rounded-lg">
            ...
            {/* TTL Configuration */}
            <div className="space-y-4">
              <Label className="text-base font-medium">Permission Duration</Label>
              <div className="flex items-center gap-4">
                <Label htmlFor="ttl-365" className="flex items-center gap-2">
                  <input 
                    type="radio" 
                    id="ttl-365"
                    name="ttl"
                ...
                <Label htmlFor="ttl-permanent" className="flex items-center gap-2">
                  <input 
                    type="radio" 
                    id="ttl-permanent"
                    name="ttl"
          ...
          <CardContent className="space-y-4">
            <div className="grid gap-3 text-sm">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium">Classification & Organization</p>
                  <p className="text-muted-foreground">
