    ...
    <main className="mx-auto max-w-3xl px-4 py-12 text-gray-900 dark:text-bfo-ivory">
      <header className="mb-8">
        ...
        <p className="mt-2 text-gray-600 dark:text-white/70">
          Organize heirs, assets, and instructions—kept current with reminders
          and audit-ready exports. Not a substitute for legal advice.
        </p>
      </header>
      ...
      <section className="prose prose-slate dark:prose-invert">
        ...
        <ul>
          <li>
            <strong>Is:</strong> A structured workflow to collect people, assets,
            documents, and wishes; share them with the right roles; and keep them
            current with reminders and change-tracking.
          </li>
          <li>
            <strong>Isn't:</strong> A will/trust generator or legal opinion.
            Use this alongside your attorney.
          </li>
        </ul>
        ...
        <ul>
          <li>
            <strong>Roles & Permissions:</strong> Viewer vs. Contributor vs. Admin;
            share grants are logged with receipts.
          </li>
          <li>
            <strong>Checklists:</strong> Progress bar + required items for an
            executor-ready state.
          </li>
          <li>
            <strong>Receipts & Exports:</strong> Each export is recorded with a
            hash so you can prove "what was shared, when."
          </li>
          <li>
            <strong>Renewals:</strong> We nudge to re-validate stale data and show
        ...
        <p>
          You control sharing. We provide encrypted storage, role-based access, and
          audit receipts on supported plans. Always store originals per your
          attorney's guidance.
        </p>
        ...
        <ul>
          <li>
            Families:{" "}
            <Link className="underline" to="/pricing#families">
              choose a plan
            </Link>{" "}
            and start the Legacy checklist.
          </li>
          <li>
            Advisors/RIA:{" "}
            <Link className="underline" to="/contact?plan=ria">
              contact sales
            </Link>{" "}
            to enable firm-wide beta.
          </li>
        </ul>
      </section>
    </main>
