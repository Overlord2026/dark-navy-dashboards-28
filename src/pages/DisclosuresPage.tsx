    ...
    <div className="flex flex-col min-h-screen bg-[#F9F7E8]">
      ...
      <main className="flex-1 py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <h1 className="text-4xl font-bold mb-8 text-[#222222]">Disclosures</h1>
          ...
          <div className="bg-white p-8 rounded-lg shadow-sm border border-[#DCD8C0] prose max-w-none">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-[#222222]">Regulatory Information</h2>
            <p className="text-gray-700">
              Boutique Family Office is a registered investment adviser with the Securities and Exchange Commission ("SEC"). Registration as an investment adviser does not imply any level of skill or training. The oral and written communications of an adviser provide you with information about which you determine to hire or retain an adviser.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-[#222222]">Professional Certifications</h2>
            <p className="text-gray-700">
            ...
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-[#222222]">Investment Performance</h2>
            <p className="text-gray-700">
              Past performance is not indicative of future results. Different types of investments involve varying degrees of risk, and there can be no assurance that any specific investment or strategy will be suitable or profitable for a client's investment portfolio.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-[#222222]">Third-Party Links</h2>
            <p className="text-gray-700">
              This website may contain links to third-party websites. We are providing these links to you only as a convenience, and the inclusion of any link does not imply endorsement, approval, or recommendation by Boutique Family Office.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-[#222222]">Additional Information</h2>
            <p className="text-gray-700">
              Additional information about Boutique Family Office is also available on the SEC's website at www.adviserinfo.sec.gov. You can search this site by a unique identifying number, known as a CRD number. The CRD number for Boutique Family Office is 123456.
            </p>
            
            <h2 className="text-2xl font-semibold mt-8 mb-4 text-[#222222]">Contact Us</h2>
            <p className="text-gray-700">
            ...
            <address className="text-gray-700 not-italic">
              ...
              Email: compliance@boutiquefamilyoffice.com<br />
              Phone: (555) 123-4567
            </address>
          </div>
        </div>
