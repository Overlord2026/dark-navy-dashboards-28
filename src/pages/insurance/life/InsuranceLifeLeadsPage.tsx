...
import { Plus, Search, Shield, Phone, Mail, Calendar, User } from "lucide-react";
...
export default function InsuranceLifeLeadsPage() {
  const { toast } = useToast();
  const [leads, setLeads] = useState(LeadModel.getByPersona('insurance'));
  ...
  const handleAddLead = async () => {
    if (!newLead.name || !newLead.email || !newLead.consent_given) {
      toast({
        title: "Error",
    ...
    try {
      ...
      const consent = recordConsentRDS({
        ...
        ttlDays: 90,
        purpose: 'life_insurance_outreach'
      });

      setLeads(LeadModel.getByPersona('insurance'));
      ...
      toast({
        title: "Lead Added",
        description: `${lead.name} added with consent receipt: ${consent.inputs_hash}`,
      });
    } catch (error) {
      toast({
        title: "Error",
  ...
  return (
    <div className="p-6 space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Life Insurance Leads</h1>
          <p className="text-muted-foreground">
            Manage prospects for life insurance and annuity products
          </p>
        </div>
        <Dialog open={isAddModalOpen} onOpenChange={setIsAddModalOpen}>
          ...
          <DialogContent className="max-w-md">
            <DialogHeader>
              <DialogTitle>Add Life Insurance Lead</DialogTitle>
            </DialogHeader>
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    placeholder="life-2025"
                  />
                </div>
              </div>

              <div className="space-y-2">
                <Label>Lead Type Tags</Label>
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  placeholder="Initial notes about prospect"
                  rows={2}
                />
              </div>
              ...
              <div className="space-y-2">
                <div className="flex items-center space-x-2">
                  ...
                  <Label htmlFor="consent" className="text-sm">
                    Prospect has given consent for life insurance outreach *
                  </Label>
                </div>
                <p className="text-xs text-muted-foreground">
                  Required for compliance. Creates Consent-RDS receipt.
                </p>
              </div>
      ...
      <div className="flex items-center gap-4">
        ...
        <Badge variant="secondary" className="flex items-center gap-1">
          ...
          {leads.filter(l => l.consent_given).length} Consented
        </Badge>
      </div>
        ...
        <Card>
          <CardContent className="p-8 text-center">
            ...
            <p className="text-muted-foreground mb-4">
              Get started by adding your first life insurance lead
            </p>
