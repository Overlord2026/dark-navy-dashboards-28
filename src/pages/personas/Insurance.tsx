...
export default function Insurance() {
  ...
  const handleOpenCatalog = () => {
    navigate('/discover?persona=insurance');
  };
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          <h1 className="text-4xl font-bold tracking-tight mb-4">
            Insurance Operations Hub
          </h1>
          <p className="text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
            Accelerate underwriting, streamline claims processing, and enhance customer 
            experiences with our modern insurance technology platform.
          </p>
        </div>
        ...
        <Card className="max-w-4xl mx-auto">
          <CardHeader>
            ...
            <CardDescription>
              Discover how our platform can modernize your insurance operations
            </CardDescription>
          </CardHeader>
          <CardContent>
