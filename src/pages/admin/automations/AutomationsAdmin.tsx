                  ...
                  <div className="flex justify-between items-start">
                    <div className="flex-1">
                      <div className="flex items-center gap-3 mb-2">
                        ...
                        <Badge className={getPriceTierColor((automation as any).price_tier ?? (automation as any).plan ?? automation.price_plan ?? 'basic')}>
                          {(automation as any).price_tier ?? (automation as any).plan ?? automation.price_plan ?? 'basic'}
                        </Badge>
