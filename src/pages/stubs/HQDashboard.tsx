    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl">HQ Dashboard</CardTitle>
        </CardHeader>
        <CardContent className="text-center space-y-4">
          <p className="text-muted-foreground">
            Headquarters operational dashboard
          </p>
          ...
          <div className="mt-6 p-4 bg-muted rounded-lg text-left">
            ...
            <ul className="text-sm space-y-1 text-muted-foreground">
              <li><strong>Route:</strong> /admin/hq</li>
              <li><strong>Component:</strong> HQDashboard</li>
              <li><strong>File:</strong> src/pages/stubs/HQDashboard.tsx</li>
            </ul>
          </div>
        </CardContent>
      </Card>
