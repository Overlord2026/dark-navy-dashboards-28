...
interface InvestmentAccountsContextType {
  accounts: InvestmentAccount[];
  loading: boolean;
  saving: boolean;
  addAccount: (accountData: InvestmentAccountData) => Promise<InvestmentAccount | null>;
...
const InvestmentAccountsContext = createContext<InvestmentAccountsContextType | undefined>(undefined);

export function InvestmentAccountsProvider({ children }: { children: React.ReactNode }) {
  ...
  return (
    <InvestmentAccountsContext.Provider
      value={{
        accounts,
        loading,
        saving,
...
export function useInvestmentAccounts() {
  const context = useContext(InvestmentAccountsContext);
  if (context === undefined) {
    throw new Error('useInvestmentAccounts must be used within an InvestmentAccountsProvider');
  }
  return context;
}