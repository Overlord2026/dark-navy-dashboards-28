...
const FamiliesPricingPage = React.lazy(() => import("./pages/pricing/FamiliesPricingPage"));
const AdvisorsPricingPage = React.lazy(() => import("./pages/pricing/AdvisorsPricingPage"));
      ...
      <TooltipProvider>
                            ...
                            <Route path="/platform-map" element={<PlatformMap />} />
                             ...
                             <Route path="/athletes/nil-landing" element={<NILLandingPage />} />
                              ...
                              <Route path="/families" element={
                               ...
                               <Route path="/pricing/families" element={
                                 <Suspense fallback={<div>Loading...</div>}>
                                   <FamiliesPricingPage />
                                 </Suspense>
                               } />
                               <Route path="/pricing/professionals/advisors" element={
                                 <Suspense fallback={<div>Loading...</div>}>
                                   <AdvisorsPricingPage />
                                 </Suspense>
                               } />
        ...
        <Route path="/image-generator" element={<ImageGeneratorPage />} />
                ...
                <Route path="/agents-os" element={<SportsAgentOS />} />
                                ...
                                <Route path="/persona/attorney-estate-planning" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/AttorneyEstatePlanningPersonaPage').then(m => ({ default: m.AttorneyEstatePlanningPersonaPage }))))}
                                  </React.Suspense>
                                } />
                                <Route path="/persona/coach-consultant" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/CoachConsultantPersonaPage').then(m => ({ default: m.CoachConsultantPersonaPage }))))}
                                  </React.Suspense>
                                } />
                                <Route path="/persona/realtor-real-estate-professional" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                ...
                                <Route path="/persona/physician" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                ...
                                <Route path="/persona/sports-agent" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/SportsAgentPersonaPage').then(m => ({ default: m.SportsAgentPersonaPage }))))}
                                  </React.Suspense>
                                } />
                                <Route path="/persona/medicare-insurance-agent" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/MedicareInsuranceAgentPersonaPage').then(m => ({ default: m.MedicareInsuranceAgentPersonaPage }))))}
                                  </React.Suspense>
                                } />
                                <Route path="/persona/imo-fmo-organization" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/IMOFMOOrganizationPersonaPage').then(m => ({ default: m.IMOFMOOrganizationPersonaPage }))))}
                                  </React.Suspense>
                                } />
                                <Route path="/persona/business-owners-entrepreneurs" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/BusinessOwnersEntrepreneursPersonaPage').then(m => ({ default: m.BusinessOwnersEntrepreneursPersonaPage }))))}
                                  </React.Suspense>
                                } />
                                <Route path="/persona/independent-women-business-owners" element={
                                  <React.Suspense fallback={<div>Loading...</div>}>
                                    {React.createElement(React.lazy(() => import('./pages/persona/IndependentWomenBusinessOwnersPersonaPage').then(m => ({ default: m.IndependentWomenBusinessOwnersPersonaPage }))))}
                                  </React.Suspense>
                                } />
