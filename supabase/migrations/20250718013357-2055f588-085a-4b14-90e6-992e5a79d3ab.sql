-- Insert test data for cleanup verification with correct structure
...
-- Insert old tracked events with required event_name field (some old, some recent)
INSERT INTO public.tracked_events (user_id, event_type, event_name, event_data, created_at) VALUES
  ('00000000-0000-0000-0000-000000000001', 'page_view', 'Home Page View', '{"page": "/old"}', NOW() - INTERVAL '100 days'),
  ('00000000-0000-0000-0000-000000000002', 'button_click', 'Old Button Click', '{"button": "old_button"}', NOW() - INTERVAL '120 days'),
  ('00000000-0000-0000-0000-000000000003', 'form_submit', 'Recent Form Submit', '{"form": "recent_form"}', NOW() - INTERVAL '10 days');