...
-- This includes users for all personas with proper tenant associations
...
INSERT INTO public.profiles (
  ...
  -- Admin user
  ('77777777-7777-7777-7777-777777777777', 'admin@test.com', 'Test Admin User', 'admin', '11111111-1111-1111-1111-111111111111', 'enterprise', 'active', '{}', true, now(), now()),
  -- System Administrator
  ('88888888-8888-8888-8888-888888888888', 'sysadmin@test.com', 'Test System Admin', 'system_administrator', '11111111-1111-1111-1111-111111111111', 'enterprise', 'active', '{}', true, now(), now())
ON CONFLICT (id) DO UPDATE SET
