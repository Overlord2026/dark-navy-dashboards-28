-- Fix persona system migration based on existing table structure

-- Add org_id column to existing personas table
...
-- Update existing personas to have org_id
DO $$
DECLARE 
  v_org UUID;
BEGIN
...
BEGIN
  ...
  ON CONFLICT (persona_kind) DO NOTHING;
END $$;
