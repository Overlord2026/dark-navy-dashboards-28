-- Phase 3: Advanced Analytics, Compliance, and KYC Tables
...
CREATE TABLE public.compliance_audit_trail (
  ...
  entity_id UUID NOT NULL,
  compliance_type TEXT NOT NULL, -- 'kyc', 'aml', 'privacy', 'lending_regulation'
  check_type TEXT NOT NULL, -- 'automated', 'manual', 'periodic'
...
CREATE POLICY "Admins can view compliance audit trail" 
...
ALTER PUBLICATION supabase_realtime ADD TABLE public.compliance_audit_trail;
...
ALTER TABLE public.compliance_audit_trail REPLICA IDENTITY FULL;
