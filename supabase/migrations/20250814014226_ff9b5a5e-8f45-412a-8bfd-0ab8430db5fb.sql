-- Trust scoring pipeline with proper column references

-- Trust scoring pipeline tables using tenant_id
...
-- Create view for latest trust scores (with correct column names)
