-- Create enhanced organization features (fixed function parameters)
...
CREATE OR REPLACE FUNCTION public.generate_organization_referral_code(
  p_organization_id UUID,
  p_prefix TEXT DEFAULT 'ORG'
)
RETURNS TEXT AS $$
DECLARE
  code TEXT;
