-- Update ONLY existing constraints that currently have NO ACTION to CASCADE
-- Based on the actual constraint list from the database

-- Tables that have NO ACTION and need CASCADE
...
ALTER TABLE public.document_permissions ADD CONSTRAINT document_permissions_user_id_fkey 
    FOREIGN KEY (user_id) REFERENCES auth.users(id) ON DELETE CASCADE;

ALTER TABLE public.document_permissions DROP CONSTRAINT document_permissions_granted_by_user_id_fkey;
ALTER TABLE public.document_permissions ADD CONSTRAINT document_permissions_granted_by_user_id_fkey 
    FOREIGN KEY (granted_by_user_id) REFERENCES auth.users(id) ON DELETE CASCADE;
...
ALTER TABLE public.family_members DROP CONSTRAINT family_members_invited_user_id_fkey;
ALTER TABLE public.family_members ADD CONSTRAINT family_members_invited_user_id_fkey 
