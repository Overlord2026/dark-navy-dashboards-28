-- Create test data for trigger validation

-- Create test bank accounts with different balances and statuses
...
INSERT INTO public.hsa_accounts (
  ...
  ('aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', '00000000-0000-0000-0000-000000000001', 'family-1', 'John HSA Individual', 'Fidelity', 5000.00, 4300.00, 2000.00, false, true),
  ('bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', '00000000-0000-0000-0000-000000000002', 'family-1', 'Jane HSA Family', 'Fidelity', 8000.00, 8550.00, 3000.00, true, true),
...
-- Create test healthcare documents
INSERT INTO public.healthcare_documents (id, user_id, name, type, category) VALUES
  ('dddddddd-dddd-dddd-dddd-dddddddddddd', '00000000-0000-0000-0000-000000000001', 'Emergency Medical Record', 'medical_record', 'medical'),
  ('eeeeeeee-eeee-eeee-eeee-eeeeeeeeeeee', '00000000-0000-0000-0000-000000000002', 'Insurance Card', 'insurance', 'insurance');