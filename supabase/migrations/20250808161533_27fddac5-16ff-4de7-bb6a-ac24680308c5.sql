-- Fix existing function return type conflict and create wrapper functions
-- Drop existing function that conflicts with return type
DROP FUNCTION IF EXISTS public.safe_graphql_schema_version();
...
-- Wrapper for graphql.get_schema_version - fixed return type
