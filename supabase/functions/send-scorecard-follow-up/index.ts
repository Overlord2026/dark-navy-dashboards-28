...
interface ScorecardFollowUpRequest {
  email: string;
  firstName?: string;
  score: number;
  band: string;
...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    const { email, firstName, score, band, persona, roadmapLink }: ScorecardFollowUpRequest = await req.json();

    const bandColor = band.includes('Green') ? '#10B981' : band.includes('Amber') ? '#F59E0B' : '#EF4444';
    const bandEmoji = band.includes('Green') ? '✅' : band.includes('Amber') ? '⚠️' : '🚨';

    const emailResponse = await resend.emails.send({
      from: "BFO Family Office <noreply@bfo.com>",
      to: [email],
      subject: `${bandEmoji} Your Retirement Confidence Score: ${score}/100`,
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px;">
          <div style="text-align: center; margin-bottom: 30px;">
            ...
            <div style="background: linear-gradient(135deg, ${bandColor}, ${bandColor}dd); color: white; padding: 20px; border-radius: 10px; margin: 20px 0;">
              <div style="font-size: 48px; font-weight: bold; margin-bottom: 10px;">${score}/100</div>
              <div style="font-size: 24px; font-weight: semibold;">${band}</div>
            </div>
          </div>
          ...
          <div style="background-color: #f8fafc; padding: 25px; border-radius: 10px; margin: 25px 0;">
            <h2 style="color: #1e40af; font-size: 20px; margin-bottom: 15px;">
              Ready for Your Personalized SWAG™ Retirement Roadmap?
            </h2>
            <p style="color: #64748b; line-height: 1.6; margin-bottom: 20px;">
              Your scorecard shows where you stand today. Now let's build your customized strategy based on these key phases:
            </p>
            
            <ul style="color: #64748b; line-height: 1.8; margin-bottom: 20px;">
              <li><strong>Income Now (Years 1–2):</strong> Essential expenses covered by safe income</li>
              <li><strong>Income Later (Years 3–12):</strong> Capital preservation with lower drawdown</li>
              <li><strong>Growth (12+ Years):</strong> Long-term wealth building aligned with your risk tolerance</li>
              <li><strong>Legacy:</strong> Estate planning and beneficiary protection</li>
            </ul>
            ...
            <div style="text-align: center; margin: 25px 0;">
              <a href="${roadmapLink}" 
                ...
                Get My SWAG™ Retirement Roadmap
              </a>
          ...
          <div style="margin: 30px 0;">
            ...
            <ul style="color: #64748b; line-height: 1.8;">
              <li>✓ Income Now/Later/Growth phase analysis</li>
              ...
              <li>✓ Secure Legacy Vault™ integration</li>
          ...
          <div style="text-align: center; margin-top: 40px; padding-top: 20px; border-top: 1px solid #e2e8f0;">
            <p style="color: #64748b; font-size: 12px; margin: 5px 0;">
              This scorecard is educational and not individualized investment, tax, or legal advice.
            </p>
            <p style="color: #64748b; font-size: 12px; margin: 5px 0;">
    ...
    console.log("Scorecard follow-up email sent successfully:", emailResponse);
    ...
    console.error("Error in send-scorecard-follow-up function:", error);
    return new Response(
